...
Menu::init()
{
    ...
    m_gui->AddCtrl( new MenuItem( CTRL_TITLES, cx, cy - 120, "Splash",
                                  m_font ) );
    m_gui->AddCtrl( new MenuItem( CTRL_START, cx, cy - 30, "Game", m_font ) );
    m_gui->AddCtrl( new MenuItem( CTRL_SCORE, cx, cy, "Score", m_font ) );
    m_gui->AddCtrl( new MenuItem( CTRL_EXIT, cx, cy + 90, "Exit", m_font ) );
